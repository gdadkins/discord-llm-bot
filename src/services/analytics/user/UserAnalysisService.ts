...
import type { LocalAnalysisResult, ILocalUserAnalyzer } from '../../interfaces/AnalyticsInterfaces';
...
export class UserAnalysisService implements IUserAnalysisService {
  ...
  constructor(localAnalyzer: ILocalUserAnalyzer, config?: Partial<UserAnalysisConfig>) {
    this.config = {
    ...
    this.metricsCollector = new UserMetricsCollector(this.config, localAnalyzer);

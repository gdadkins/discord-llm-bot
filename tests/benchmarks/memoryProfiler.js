...
exports.AdvancedMemoryProfiler = void 0;
...
class AdvancedMemoryProfiler {
    ...
    setupGCObserver() {
        try {
            if (typeof global.gc === 'function') {
                ...
                if (perf_hooks_1.performance.eventLoopUtilization && perf_hooks_1.performance.PerformanceObserver) {
                    const PerformanceObserver = perf_hooks_1.performance.PerformanceObserver;
    ...
    startSession(operation, parameters) {
    ...
    generateRecommendations(snapshots, growthRate, peakUsage) {
    ...
    exportReport(outputPath) {
        ...
        const reportPath = (0, path_1.join)(reportDir, `memory-profile-${timestamp}.json`);
        const report = {
    ...
    static profileFunction(fn, label) {
    ...
    static async profileBenchmark(benchmarkFn, iterations, label) {
...
exports.AdvancedMemoryProfiler = AdvancedMemoryProfiler;

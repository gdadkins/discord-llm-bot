...
exports.runContextManagerBenchmarks = runContextManagerBenchmarks;
const base_1 = require("./base");
const contextManager_1 = require("../../src/services/contextManager");
async function runContextManagerBenchmarks() {
    const suite = new base_1.BenchmarkSuite();
    // Test data generation
    const generateContext = (size) => {
        const contexts = [];
    ...
    const generateServerContext = (items) => {
        const context = {
            embarrassingMoments: [],
            runningGags: [],
            codeSnippets: []
    ...
    suite.add('ContextManager - buildSuperContext small', () => {
        ...
        // Set server contexts
        serverContext.embarrassingMoments.forEach((m) => manager.addEmbarrassingMoment('testServer', m.userId, m.moment));
        serverContext.runningGags.forEach((g) => manager.addRunningGag('testServer', g));
...
//# sourceMappingURL=contextManager.bench.js.map